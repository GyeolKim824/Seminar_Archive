...
class Event implements ActionListener {
    ...
    public Event(JTextField tf1, JTextField tf2, JLabel l, DefaultListModel<String> historyModel) {
        this.tf_1 = tf1;
        this.tf_2 = tf2;
        this.l_1 = l;
    ...
    public void actionPerformed(ActionEvent a) {
        try {
            ...
            historyModel.addElement(tf_1.getText() + " " + a.getActionCommand() + " " + tf_2.getText() + " = " + result);
...
class Calculator extends JFrame {
    ...
    Calculator() {
        ...
        this.historyList = new JList<>(historyModel);

        Event a = new Event(this.tf_num1, this.tf_num2, this.l_result_out, this.historyModel);
        ...
        historyList.addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                ...
                if (selectedValue != null && !selectedValue.isEmpty()) {
                    ...
                    tf_num1.setText(numbers[0]);
                    tf_num2.setText(numbers[2]);
                }
            }
        });
    }
